...
export default function Alert({handleClick, text, type}) {
  return (
    ...
    className="fixed top-2  mx-[25%] bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3 rounded-2xl z-10"     // Animation duration
    >           
    <strong className="font-bold">{type}:</strong>
        <span className="block sm:inline"> {text}</span>
        <span onClick={handleClick} className="absolute top-0  right-0 px-4 py-3">
